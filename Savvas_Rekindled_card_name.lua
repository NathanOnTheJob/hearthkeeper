...
cardNames = {
  "Attack Modifier (+0)",
  "Attack Modifier (+0) (Grant one ally: (move) 2 or (attack) 2)",
  "Attack Modifier (+0) (Grant one ally: (move) 2 or (attack) 2)",
  "Attack Modifier (+0) wound",
  "Attack Modifier (+0) wound",
  "Attack Modifier (+1 (attack) for each pair of active (icon)) rolling",
  "Attack Modifier (+1 (attack) for each pair of active (icon)) rolling",
  "Attack Modifier (+1) fire",
  "Attack Modifier (+1) fire",
  "Attack Modifier (+1) (Place a (icon) in a hex adjacent to or occupied by the target of the attack)",
  "Attack Modifier (+1) (Place a (icon) in a hex adjacent to or occupied by the target of the attack)",
  "Attack Modifier bless (range) 3 rolling",
  "Attack Modifier disarm (range) 3 rolling",
  "Attack Modifier bless (range) 3 rolling",
  "Attack Modifier disarm (range) 3 rolling",
}
cardDescriptions = {
