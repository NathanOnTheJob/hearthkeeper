...
cardNames = {
  ...
  "Attack Modifier (+0) (Move the token on a (icon) backward one slot)",
  "Attack Modifier (+0) (After this attack ability, grant one ally: (move) 2)",
  "Attack Modifier (+0) (After this attack ability, grant one ally: (move) 2)",
  "Attack Modifier (+1) push 2",
  "Attack Modifier (+1) push 2",
  "Attack Modifier (+1) (If you or the target is occupying or adjacent to a (icon), (+2) instead)",
  "Attack Modifier (+1) (If you or the target is occupying or adjacent to a (icon), (+2) instead)",
  ...
  "Attack Modifier ((heal) 1, (target) 1 ally) rolling",
  "Attack Modifier ((heal) 1, (target) 1 ally) rolling",
  "Attack Modifier disarm rolling",
}
cardDescriptions = {
  "Rekindled",
  "Rekindled",
