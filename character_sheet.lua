masteryPos = {
  ...
  [1] = {x=-0.6783098060344828, y=0.11, z=0.6849331644663483},
  --[] Over the course of a scenario, have the same ally receive a benefit from a [icon] during 10 different rounds
  [2] = {x=-0.6783098060344828, y=0.11, z=0.7920902795941687},
}
perkPos = {
  --[] Remove one [-2] card
  [1] = {x=0.1631076239224139, y=0.11, z=-0.6450733057088971},
  --[][] Replace one [-1] card with one [+0] "Move the token on a [icon] backward one slot" -rolling card
  [2] = {x=0.1631076239224139, y=0.11, z=-0.5658067757877783},
  [3] = {x=0.20780051185344822, y=0.11, z=-0.5658067757877783},
  --[][] Replace one [-1] card with one [+1] "Move one [icon] one hex" card
  [4] = {x=0.1631076239224139, y=0.11, z=-0.3334861854875346},
  [5] = {x=0.20780051185344822, y=0.11, z=-0.3334861854875346},
  --[][] Replace one [+0] card with one [+1] push 2 card
  [6] = {x=0.1631076239224139, y=0.11, z=-0.15232127861675918},
  [7] = {x=0.20780051185344822, y=0.11, z=-0.15232127861675918},
  --[][] Replace one [+0] card with one [+0] "Grant one ally: [move] 2" card
  [8] = {x=0.1631076239224139, y=0.11, z=-0.021899065266172052},
  [9] = {x=0.20780051185344822, y=0.11, z=-0.021899065266172052},
  --[][][] Add one [+2] fire card
  [10] = {x=0.1631076239224139, y=0.11, z=0.10852314808441507},
  [11] = {x=0.20780051185344822, y=0.11, z=0.10852314808441507},
  [12] = {x=0.25249339978448276, y=0.11, z=0.10852314808441507},
  --[] Ignore scenario effects and replace two [+0] cards with two wound rolling cards
  [13] = {x=0.1631076239224139, y=0.11, z=0.18778967800553412},
  --[] Whenever you short rest, you may [consume] fire to move the token backward one slot on all of your active [icon]
  [14] = {x=0.1631076239224139, y=0.11, z=0.3689545848763096},
  --[] Whenever you long rest, you may destroy a [icon] to bless, bless self
  [15] = {x=0.1631076239224139, y=0.11, z=0.6007245219641801},
  --[||] When an enemy enters a hex containing a [icon], that enemy immediately suffers [damage] 1 and gains wound
  [16] = {x=0.1631076239224139, y=0.11, z=0.7307337454054872},
  [17] = {x=0.1631076239224139, y=0.11, z=0.7594064959442803},
  [18] = {x=0.1631076239224139, y=0.11, z=0.7880792464830734},
}
