deckInfo = {
  ...
  description = "Hearthkeeper",
}
cardNames = {
  "Attack Modifier (+0) (Move the token on a (icon) backward one slot) -rolling",
  "Attack Modifier (+0) (Move the token on a (icon) backward one slot) -rolling",
  "Attack Modifier (+1) (Move one (icon) one hex)",
  "Attack Modifier (+1) (Move one (icon) one hex)",
  "Attack Modifier (+1) push 2",
  "Attack Modifier (+1) push 2",
  "Attack Modifier (+0) (Grant one ally: (move) 2)",
  "Attack Modifier (+0) (Grant one ally: (move) 2)",
