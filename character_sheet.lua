...
perkPos = {
  ...
  [3] = {x=0.16235935039370078, y=0.11, z=-0.5082988899237294},
  [4] = {x=0.20528749999999998, y=0.11, z=-0.5082988899237294},
  --[|] Add one [+4] card
  [5] = {x=0.16235935039370078, y=0.11, z=-0.3717167165907317},
  [6] = {x=0.16235935039370078, y=0.11, z=-0.34417178548836946},
  --[][][] Replace one [+0] card with one [+1] "Kill the attacking summon to instead add [+4]" card
  [7] = {x=0.16235935039370078, y=0.11, z=-0.2842296171369597},
  [8] = {x=0.20528749999999998, y=0.11, z=-0.2842296171369597},
  [9] = {x=0.2482156496062992, y=0.11, z=-0.2842296171369597},
  --[][][] Add one [+2] earth-dark card
  [10] = {x=0.16235935039370078, y=0.11, z=-0.04975935761572739},
  [11] = {x=0.20528749999999998, y=0.11, z=-0.04975935761572739},
  [12] = {x=0.2482156496062992, y=0.11, z=-0.04975935761572739},
  --[] Ignore scenario effects and add two [+1] cards
  [13] = {x=0.16235935039370078, y=0.11, z=0.03772774183804459},
  --[] Immediately before each of your rests, you may kill one of your summons to perform bless, self
  [14] = {x=0.16235935039370078, y=0.11, z=0.17400785360082557},
  ...
  [15] = {x=0.16235935039370078, y=0.11, z=0.3590809776726156},
